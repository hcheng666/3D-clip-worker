...
VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS="${CLIP_WORKER_VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS:-${DEFAULT_VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS}}"
VCPKG_DOWNLOAD_MAX_TIME_SECONDS="${CLIP_WORKER_VCPKG_DOWNLOAD_MAX_TIME_SECONDS:-${DEFAULT_VCPKG_DOWNLOAD_MAX_TIME_SECONDS}}"
...
validate_positive_integer "vcpkg download connect timeout" \
    "${VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS}"
validate_positive_integer "vcpkg download maximum time" \
    "${VCPKG_DOWNLOAD_MAX_TIME_SECONDS}"
...
docker build \
    ...
    --build-arg "VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS=${VCPKG_DOWNLOAD_CONNECT_TIMEOUT_SECONDS}" \
    --build-arg "VCPKG_DOWNLOAD_MAX_TIME_SECONDS=${VCPKG_DOWNLOAD_MAX_TIME_SECONDS}" \
